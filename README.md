<h2> Hi, I'm Akmal Dira! <img src="https://media.giphy.com/media/mGcNjsfWAjY5AEZNw6/giphy.gif" width="50"></h2>
...
```javascript
const akmal = {
  code: [Javascript, HTML, CSS, PHP, Golang, Java],
  tools: [React, Node, Express, Gin, Spring, Jest, Docker],
